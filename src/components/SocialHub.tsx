...
const socials: Social[] = [
  ...
  { name: "Telegram", tip: "Contact", href: "https://t.me/renthality", icon: (
  ...
  { name: "Instagram", tip: "Personal Content", href: "https://www.instagram.com/renthality", icon: (
  ...
  { name: "Spotify", tip: "Music", href: "https://open.spotify.com/user/21vybuvzvxxfudqrbfmbvqjba", icon: (
  ...
  { name: "Twitch", tip: "Streaming", href: "https://www.twitch.tv/renthality", icon: (
